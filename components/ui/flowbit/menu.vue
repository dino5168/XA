...
import companyLogo from "../logo/company.vue"
</script>
<template>
    <nav class="bg-gray-200 border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <companyLogo img-src="/images/Logo.png" desc="恐龍網站設計公司">

            </companyLogo>
            <UiFlowbitButtonRwd></UiFlowbitButtonRwd>
            <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
                <ul
                    class="flex flex-col font-medium p-4 md:p-0 mt-4 border bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">

                    <UiFlowbitHref link="/ui/alert">首頁</UiFlowbitHref>
