...
<template>
    <AlertDialogRoot>
        ...
        <AlertDialogTrigger
            class="bg-blue-500 text-grass11 font-semibold hover:bg-white/90 shadow-sm inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] leading-none outline-none focus:shadow-[0_0_0_2px] focus:shadow-black transition-all">
            Delete account
        </AlertDialogTrigger>
        <AlertDialogPortal>
            <AlertDialogOverlay class="bg-blue-100 data-[state=open]:animate-overlayShow fixed inset-0 z-30" />
            <AlertDialogContent
                ...
                <div class="flex justify-end gap-[25px]">
                    <AlertDialogCancel
                        class="text-blue-500 bg-blue-600 hover:bg-blue-700 focus:shadow-blue-800 inline-flex h-[35px] items-center justify-center rounded-[4px] px-[15px] font-semibold leading-none outline-none focus:shadow-[0_0_0_2px]">
                        取消
                    </AlertDialogCancel>
                    <AlertDialogAction
