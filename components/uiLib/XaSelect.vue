    ...
    <SelectRoot v-model="fruit">
        ...
        <SelectPortal>
            <SelectContent
                ...
                <SelectViewport class="p-[5px]">
                    ...
                    <SelectGroup>
                        <SelectItem v-for="(option, index) in vegetables" :key="index"
                            class="text-sm leading-none text-green-300 rounded-[3px] flex items-center h-[25px] pr-[35px] pl-[25px] relative select-none data-[disabled]:text-mauve8 data-[disabled]:pointer-events-none data-[highlighted]:outline-none data-[highlighted]:bg-green9 data-[highlighted]:text-green1"
                ...
                <SelectScrollDownButton
                    class="flex items-center justify-center h-[25px] bg-white text-blue-500 cursor-pointer">
