...
import NavigationMenuListItem from './XaNavMenuItem.vue'
                    ...
                    <ul class="one m-0 grid list-none gap-x-[10px] p-[22px] sm:w-[500px] sm:grid-cols-[0.75fr_1fr]">
                        <li class="row-span-3 grid">
                            <NavigationMenuLink as-child>
                                <a class="focus:shadow-green7 from-green9 to-teal9 flex h-full w-full select-none flex-col justify-end rounded-[6px] bg-gradient-to-b p-[25px] no-underline outline-none focus:shadow-[0_0_0_2px]"
                                    href="/">
                                    <img class="w-16" src="https://www.radix-vue.com/logo.svg">
                                    <div class="mt-4 mb-[7px] text-[18px] font-medium leading-[1.2] text-white">Radix
                                        Primitives</div>
                                    <p class="text-mauve4 text-[14px] leading-[1.3]">Unstyled, accessible components for
                                        Vue.</p>
                                </a>
                            </NavigationMenuLink>
                        </li>
            ...
            <NavigationMenuItem>
                ...
                <NavigationMenuContent
                    ...
                    <ul class="m-0 grid list-none gap-x-[10px] p-[22px] sm:w-[600px] sm:grid-flow-col sm:grid-rows-3">
                        ...
                        <NavigationMenuListItem title="Getting started"
